...
public class NengCipeDAO {
	private Connection conn = null;
	private PreparedStatement pstmt = null;
	private ResultSet rs = null;
	
	// 레시피 등록후 글번호(rec_id)반환
	public int insertRecipe(NengCipeDTO recipe) {
		int num = 0;
		try {
	...
	public List <NengCipeDTO> getRecipes(int start, int end, int master, String id) {
		...
		String sql = "";
			try {
				...
				rs = pstmt.executeQuery();
				recipeList = new ArrayList <NengCipeDTO> (end);
				while(rs.next()) {
					NengCipeDTO recipe = new NengCipeDTO();
	...
	public NengCipeDTO getRecipes(int num) {
			NengCipeDTO recipe = null;
			try {
				conn = ConnectionDAO.getConn();
	...
	//레시피 수정(이미지 제외)
	public void updateRecipe(NengCipeDTO recipe) {
		try {
			conn = ConnectionDAO.getConn();
	...
	public void updateImage(NengCipeDTO recipe) {
		try {
			conn = ConnectionDAO.getConn();
	...
	// 컬럼별 검색결과 반환
	public List <NengCipeDTO> getRecipes(String col, String search, int start, int end, int master, String id) {
		List <NengCipeDTO> recipeList = null;
		String sql = "";
			try {
				conn = ConnectionDAO.getConn();
	...
	public List <NengCipeDTO> getBestRecipes(int number) {
		List <NengCipeDTO> recipeList = null;
			try {
				conn = ConnectionDAO.getConn();
				...
				rs = pstmt.executeQuery();
				recipeList = new ArrayList <NengCipeDTO> (number);
				while(rs.next()) {
					NengCipeDTO recipe = new NengCipeDTO();
					recipe.setNum(rs.getInt("num"));
					recipe.setName(rs.getString("name"));
	...
	public List <NengCipeDTO>  getRecipes(List<Integer> recList, int start, int end, int master, String id) {
		List<NengCipeDTO> recipeList = null;
		int recNum = 0;
		int n = recList.size();
		String sql = "";
	...
	public List <NengCipeDTO>  getRecipes(List<Integer> recList, String search, int start, int end, int master, String id) {
		List<NengCipeDTO> recipeList = null;
		int recNum = 0;
		int n = recList.size();
		String sql = "";
	...
	// search로 검색 된 추천 레시피 게시판 한페이지에 보여줄 레시피 목록 반환
	public List <NengCipeDTO>  getRecipes(List<Integer> recList, String col, String search, int start, int end, int master, String id) {
		List<NengCipeDTO> recipeList = null;
		int recNum = 0;
		int n = recList.size();
		String sql = "";
