...
public class NengDAO {
	...
	// 재료 불러오기 - cook 테이블 이용
	public List <NengDTO> getIng(int num) {
		List<NengDTO> ingList = new ArrayList <NengDTO> ();
		try {
	...
	public boolean insertIng(NengDTO cook) {
	...
	public List <NengDTO> getIng (int startRow, int endRow) throws Exception {
		List<NengDTO> ingList = null;
		try {
			conn = ConnectionDAO.getConn();
	...
	// 재료 수정
	public boolean updateIng(NengDTO cook) {
		boolean result = false;
		try {
			conn = ConnectionDAO.getConn();
	...
	//재료 삭제
	public void deleteIng(NengDTO cook) {
		try {
			conn = ConnectionDAO.getConn();
	...
	public List <NengDTO> getIng (String search, int startRow, int endRow) throws Exception {
		List<NengDTO> ingList = null;
		try {
			conn = ConnectionDAO.getConn();
	...
	public void changeRec_id(int random_id, int rec_id, NengDTO cook) {
		try {
			conn = ConnectionDAO.getConn();
