...
<tr>
	...
	<%
		if(recipe.getImage() == null){%>
			사진이 등록되지 않았습니다. <br />
	<% 	} else{%>
			<img src="/myneng/recipeSave/<%=recipe.getImage() %>" width="600" /> <br />
	<%	} %>
	</td>
</tr>	
<tr>
	<td align="center" bgcolor="#d6cabc">요리명</td>
	<td align="center"><%=recipe.getName() %></td>
	<td align="center" bgcolor="#d6cabc">작성자</td>
	<td align="center"><%=recipe.getWriter() %></td>
						
</tr>
<tr>
	<td align="center" bgcolor="#d6cabc">재료</td>
...
<tr>
	<td align="center" bgcolor="#d6cabc">요리시간</td>
	<td align="center"><%=recipe.getCooking_time()%> 분</td>
	<td align="center" bgcolor="#d6cabc">요리난이도</td>
