...
<jsp:useBean id="article" scope="page" class="groupBuying.comment.CommentDataBean" />
...
else
{
    ...
    article.setReg_date(new Timestamp(System.currentTimeMillis()) );
   	...
   	int return_comment_pageNum = dbPro.insertArticle_comment(article,comment_listNum,comment_pageNum);
