...
<%
	...
	recipe.bean.RecipeDAO menu_dao = new recipe.bean.RecipeDAO();
	int master_number = menu_dao.getMemberMaster(id); 
if(id!=null){%>
...
<ul>
 <li><a href="#">나의 냉장고</a>
 	<ul>
 	<%if(master_number == 2) { %>
 	 <li><a href="/myneng/myRefrigerator/addIng.jsp">재료추가</a></li>
 	 <li><a href="/myneng/myRefrigerator/groupMember.jsp">그룹현황</a></li>
 	...
 	<%}else { %>
 	 ...
 	 <li><a href="/myneng/memo/memoView.jsp">장보기 메모</a></li>
 	<%}%>
 	</ul>
 </li>
 <li><a href="#" id="current">레시피</a>
	<ul>
     ...
     <%if(master_number == 2) { %>
 	<li><a href="/myneng/recipe/recipeDeleteList.jsp">삭제된 레시피</a></li>
 	<%}%>
    </ul>
 </li>
 <li><a href="#">장보기</a>
 ...
 <li><a href="#">나의 정보</a>
 	<ul>
 	<%if(master_number == 2) { %>
     <li><a href="/myneng/myinfo/recipeScrapTotal.jsp">찜한 레시피</a></li>
     <li><a href="/myneng/diet/dietCalendar.jsp">식단 짜기</a></li>
     <li><a href="/myneng/myinfo/memberInfo.jsp">홈페이지 정보 통계</a></li> 	
 	<%}else { %>
