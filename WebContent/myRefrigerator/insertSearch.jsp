...
<%
	...
	String se = "";										// 리펙으로 ingList 호출한 부분으로 합침
...
<input type = "hidden" id = "setSearch" name = "setSearch" value = "<%=search%>">
<div class="center">
...
if(tempIngList != null){	
	...
	String returnPageNum = mnDB.getIngPageNum(show.getIngname(),pageSize);
	System.out.println(returnPageNum);
%>
	<tr>
    	<td>
